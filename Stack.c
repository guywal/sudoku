 ...
 * Each cell is represented by 3 ints in stk->arr which represent x,y and value.
 * The stack object has 2 ints to represent when and what'ss the current last cell.
 */
